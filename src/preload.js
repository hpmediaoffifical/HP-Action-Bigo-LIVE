...
contextBridge.exposeInMainWorld('bigo', {
  ...
  effectsResolveUrl: (mediaFile) => ipcRenderer.invoke('effects:resolve-url', mediaFile),
  ...
  giftsNotesImport: (entries) => ipcRenderer.invoke('gifts:notes-import', entries),
  ...
  hotkeySend: (opts) => ipcRenderer.invoke('hotkey:send', opts),
  ...
  jarGetUrl: () => ipcRenderer.invoke('jar:get-url'),
  jarCopyUrl: () => ipcRenderer.invoke('jar:copy-url'),
  jarConfig: (cfg) => ipcRenderer.invoke('jar:config', cfg),
  jarEvent: (ev) => ipcRenderer.invoke('jar:event', ev),
  jarClear: () => ipcRenderer.invoke('jar:clear'),
  jarAction: (type, count) => ipcRenderer.invoke('jar:action', type, count),
  jarInfo: (list) => ipcRenderer.invoke('jar:info', list),
  jarInfoCopyUrl: () => ipcRenderer.invoke('jar:info-copy-url'),
